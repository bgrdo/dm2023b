...
PARAM <- list()
<<<<<<< HEAD
PARAM$experimento <- "9TS6410"

PARAM$exp_input <- "9FE6310"
=======
PARAM$experimento <- "8TS6410"

PARAM$exp_input <- "8FE6310"
...
PARAM$train$semilla <- 199999 # cambiar por su propia semilla  !!!
